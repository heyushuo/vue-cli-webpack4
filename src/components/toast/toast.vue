<template>
  <transition
    name="fade"
    enter-to-class="v-toast-show"
    leave-class="v-toast-show"
    enter-class="v-toast-hide"
    leave-to-class="v-toast-hide"
  >
    <div class="v-toast" :class="{'v-toast-loading':type==='loading'}" v-show="isShowing">
      <div class="loading">
